...
export declare class ExtendedPath2D {
    ...
    appendSvg(parts: SVGPathSegment[]): void;
    ellipse(x1: number, y1: number, rx: number, ry: number, rotation: number, fA: number, fS: number, x2: number, y2: number): void;
    ellipticalArc(cx: number, cy: number, rx: number, ry: number, rotation: number, sAngle: number, eAngle: number, counterClockwise: boolean): void;
