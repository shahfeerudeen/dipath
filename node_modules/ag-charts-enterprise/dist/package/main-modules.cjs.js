...
var { AxisInterval, Property } = import_ag_charts_community._ModuleSupport;
...
var { BaseProperties, ChartAxisDirection, Property: Property2, Group } = import_ag_charts_community2._ModuleSupport;
...
var PolarCrossLine = class extends BaseProperties {
  constructor() {
    super(...arguments);
    this.id = (0, import_ag_charts_core.createId)(this);
...
var AngleCrossLine = class extends PolarCrossLine {
  ...
  visibilityCheck() {
    ...
    if ((0, import_ag_charts_core2.isArray)(value)) {
  ...
  updateLabelNode(visible) {
    ...
    if (type === "line") {
      ...
      const isRightSide = (0, import_ag_charts_core2.isNumberEqual)(angle, angle270) || angle > angle270 || angle < Math.PI / 2;
      ...
      const isBottomSide = ((0, import_ag_charts_core2.isNumberEqual)(angle, 0) || angle > 0) && angle < Math.PI;
      let distance;
...
var AngleAxis = class extends import_ag_charts_community4._ModuleSupport.PolarAxis {
  ...
  calculateTickLayout(domain) {
    ...
    const fractionDigits = ticks.reduce(
      (f, t) => Math.max(typeof t === "number" ? (0, import_ag_charts_core3.countFractionDigits)(t) : 0, f),
      0
    );
    return {
      niceDomain,
  ...
  getAxisLinePoints() {
    ...
    const isFullCircle = (0, import_ag_charts_core3.isNumberEqual)(endAngle - startAngle, 2 * Math.PI);
    const points = [];
    if (shape === "circle") {
      if (isFullCircle) {
        points.push(
  ...
  createLabelNodeData(ticks, options, seriesRect) {
    ...
    const labelData = ticks.map((datum, index) => {
      ...
      const isLastTickOverFirst = index === ticks.length - 1 && value !== ticks[0] && (0, import_ag_charts_core3.isNumberEqual)(normalizeAngle3602(angle), normalizeAngle3602(scale.convert(ticks[0])));
  ...
  getLabelAlign(tickAngle) {
    ...
    let textBaseline;
    const orientation = this.getLabelOrientation();
    const isCos0 = (0, import_ag_charts_core3.isNumberEqual)(cos, 0);
    const isSin0 = (0, import_ag_charts_core3.isNumberEqual)(sin, 0);
    const isCos1 = (0, import_ag_charts_core3.isNumberEqual)(cos, 1);
    const isSinMinus1 = (0, import_ag_charts_core3.isNumberEqual)(sin, -1);
...
// packages/ag-charts-enterprise/src/axes/angle-category/angleCategoryAxis.ts
var { Property: Property4, CategoryScale } = import_ag_charts_community5._ModuleSupport;
var AngleCategoryAxis = class extends AngleAxis {
  ...
  avoidLabelCollisions(labelData) {
    ...
    const lastLabelIsOverFirst = (0, import_ag_charts_core4.isNumberEqual)(firstLabel.x, lastLabel.x) && (0, import_ag_charts_core4.isNumberEqual)(firstLabel.y, lastLabel.y);
...
var LinearAngleScale = class _LinearAngleScale extends LinearScale {
  ...
  hasNiceRange() {
    ...
    return niceRanges.some((r) => (0, import_ag_charts_core5.isNumberEqual)(r, sortedRange[1] - sortedRange[0]));
  }
...
// packages/ag-charts-enterprise/src/axes/angle-number/angleNumberAxis.ts
var { Property: Property5, angleBetween, normalisedExtentWithMetadata, findMinMax } = import_ag_charts_community7._ModuleSupport;
var AngleNumberAxis = class extends AngleAxis {
  ...
  avoidLabelCollisions(labelData) {
    ...
    const firstLabel = labelData[0];
    const lastLabel = labelData.at(-1);
    if (firstLabel !== lastLabel && (0, import_ag_charts_core6.isNumberEqual)(firstLabel.x, lastLabel.x) && (0, import_ag_charts_core6.isNumberEqual)(firstLabel.y, lastLabel.y)) {
...
var { OrdinalTimeScale, Property: Property6, TimeAxisParentLevel } = import_ag_charts_community8._ModuleSupport;
...
var RadiusCrossLine = class extends PolarCrossLine {
  ...
  update(visible) {
    const { scale } = this;
    if (!scale || !validateCrossLineValue2(getCrossLineValue2(this), scale)) {
      this.rangeGroup.visible = false;
      this.lineGroup.visible = false;
      this.labelGroup.visible = false;
      return;
  ...
  updateSectorNode(visible) {
    ...
    const padding = this.getPadding();
    const r0 = (0, import_ag_charts_core7.clamp)(axisInnerRadius, innerRadius + padding, axisOuterRadius);
    const r1 = (0, import_ag_charts_core7.clamp)(axisInnerRadius, outerRadius - padding, axisOuterRadius);
...
// packages/ag-charts-enterprise/src/axes/radius-category/radiusCategoryAxis.ts
var { ProxyPropertyOnWrite, Property: Property9, CategoryScale: CategoryScale2 } = import_ag_charts_community11._ModuleSupport;
...
var { Property: Property10, normalisedExtentWithMetadata: normalisedExtentWithMetadata2, LinearScale: LinearScale2 } = import_ag_charts_community12._ModuleSupport;
...
var { Chart, Property: Property11 } = import_ag_charts_community14._ModuleSupport;
...
// packages/ag-charts-enterprise/src/charts/flowProportionChartModule.ts
var { isAgFlowProportionChartOptions, flowProportionChartOptionsDefs } = import_ag_charts_community15._ModuleSupport;
...
var { Chart: Chart2 } = import_ag_charts_community16._ModuleSupport;
...
// packages/ag-charts-enterprise/src/charts/gaugeChartModule.ts
var { isAgGaugeChartOptions, gaugeChartOptionsDefs } = import_ag_charts_community17._ModuleSupport;
...
var { Chart: Chart3 } = import_ag_charts_community18._ModuleSupport;
...
// packages/ag-charts-enterprise/src/charts/hierarchyChartModule.ts
var { isAgHierarchyChartOptions, hierarchyChartOptionsDefs } = import_ag_charts_community19._ModuleSupport;
...
var { Chart: Chart4 } = import_ag_charts_community20._ModuleSupport;
...
// packages/ag-charts-enterprise/src/charts/standaloneChartModule.ts
var { isAgStandaloneChartOptions, standaloneChartOptionsDefs } = import_ag_charts_community21._ModuleSupport;
...
var { Chart: Chart5, MercatorScale, NumberAxis, Property: Property12 } = import_ag_charts_community22._ModuleSupport;
...
// packages/ag-charts-enterprise/src/charts/topologyChartModule.ts
var { isAgTopologyChartOptions, topologyChartOptionsDefs } = import_ag_charts_community23._ModuleSupport;
...
} = import_ag_charts_community24._ModuleSupport;
var serializableDate = (0, import_ag_charts_core10.optionsDefs)(
  {
    __type: (0, import_ag_charts_core10.required)((0, import_ag_charts_core10.constant)("date")),
    value: (0, import_ag_charts_core10.or)(import_ag_charts_core10.string, import_ag_charts_core10.number)
  },
  "a serializable date object"
);
var xValue = (0, import_ag_charts_core10.or)(import_ag_charts_core10.string, import_ag_charts_core10.number, serializableDate);
var annotationValue = (0, import_ag_charts_core10.or)(
  xValue,
  (0, import_ag_charts_core10.optionsDefs)({
    value: xValue,
    groupPercentage: (0, import_ag_charts_core10.numberRange)(-1, 1)
  })
);
var channelAnnotationTextOptionsDef = {
  ...annotationChannelTextDefs,
  label: import_ag_charts_core10.string
};
...
var annotationPointOptionsDef = {
  x: annotationValue,
  y: import_ag_charts_core10.number
};
var annotationInitialStateOptionsDef = (0, import_ag_charts_core10.typeUnion)(
  {
    line: {
      ...annotationLineStyleDefs,
    ...
    "disjoint-channel": {
      ...annotationDisjointChannelStyleDefs,
      startHeight: import_ag_charts_core10.positiveNumber,
      endHeight: import_ag_charts_core10.positiveNumber,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef,
    ...
    "parallel-channel": {
      ...annotationParallelChannelStyleDefs,
      height: import_ag_charts_core10.positiveNumber,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef,
      text: channelAnnotationTextOptionsDef
    },
    "fibonacci-retracement": {
      ...
      text: lineAnnotationTextOptionsDef,
      reverse: import_ag_charts_core10.boolean
    },
    ...
    callout: {
      ...
      text: import_ag_charts_core10.string
    },
    comment: {
      ...annotationCommentStylesDefs,
    ...
    "date-range": {
      ...annotationMeasurerStylesDefs,
      extendAbove: import_ag_charts_core10.boolean,
      extendBelow: import_ag_charts_core10.boolean,
      text: lineAnnotationTextOptionsDef,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef
    },
    "price-range": {
      ...annotationMeasurerStylesDefs,
      extendLeft: import_ag_charts_core10.boolean,
      extendRight: import_ag_charts_core10.boolean,
      text: lineAnnotationTextOptionsDef,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef
    },
...
var initialStateOptionsDef = {
  chartType: (0, import_ag_charts_core10.union)("candlestick", "hollow-candlestick", "ohlc", "line", "step-line", "hlc", "high-low"),
  annotations: (0, import_ag_charts_core10.arrayOfDefs)(annotationInitialStateOptionsDef),
  legend: (0, import_ag_charts_core10.arrayOfDefs)(
    {
      visible: import_ag_charts_core10.boolean,
      seriesId: import_ag_charts_core10.string,
      itemId: import_ag_charts_core10.string,
      legendItemName: import_ag_charts_core10.string
    },
    "legend state array"
  ),
  zoom: {
    rangeX: {
      start: (0, import_ag_charts_core10.or)(import_ag_charts_core10.number, serializableDate),
      end: (0, import_ag_charts_core10.or)(import_ag_charts_core10.number, serializableDate)
    },
    rangeY: {
      start: (0, import_ag_charts_core10.or)(import_ag_charts_core10.number, serializableDate),
      end: (0, import_ag_charts_core10.or)(import_ag_charts_core10.number, serializableDate)
    ...
    ratioX: {
      start: import_ag_charts_core10.ratio,
      end: import_ag_charts_core10.ratio
    },
    ratioY: {
      start: import_ag_charts_core10.ratio,
      end: import_ag_charts_core10.ratio
    },
    autoScaledAxes: (0, import_ag_charts_core10.arrayOf)((0, import_ag_charts_core10.constant)("y"))
  }
};
...
var { ScalableGroup, Rect, Line: Line3, BBox: BBox2, Selection: Selection3, applyShapeFillBBox } = import_ag_charts_community25._ModuleSupport;
var BoxPlotGroup = class extends ScalableGroup {
  ...
  distanceSquared(x, y) {
    ...
    return import_ag_charts_community25._ModuleSupport.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
    const datum = this.datum;
    if (datum.midPoint === void 0) {
      import_ag_charts_core11.Logger.error("BoxPlotGroup.datum.midPoint is undefined");
      return { x: NaN, y: NaN };
    }
...
var {
  ...
  isGradientFill,
  getShapeStyle
} = import_ag_charts_community27._ModuleSupport;
var BoxPlotSeriesNodeEvent = class extends import_ag_charts_community27._ModuleSupport.SeriesNodeEvent {
...
var BoxPlotSeries = class extends import_ag_charts_community27._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesRange(_direction, visibleRange) {
    return this.domainForVisibleRange(ChartAxisDirection6.Y, ["maxValue", "minValue"], "xValue", visibleRange, true);
  }
  createNodeData() {
  ...
  getItemStyleOverrides(datumId, datum, format, highlighted) {
    ...
    return getShapeStyle(overrides, fillGradientDefaults4, fillPatternDefaults4, fillImageDefaults4);
  }
  updateDatumNodes({
    datumSelection,
    ...
    datumSelection.each((boxPlotGroup, nodeDatum) => {
      ...
      if (highlighted) {
        activeStyles = mergeDefaults2(highlightStyle.item, activeStyles);
      }
      const { stroke, strokeWidth, strokeOpacity, lineDash, lineDashOffset } = activeStyles;
      activeStyles.whisker = mergeDefaults2(activeStyles.whisker, {
        stroke,
        strokeWidth,
        strokeOpacity,
        lineDash,
    ...
    if (itemStyler) {
      ...
      if (formatStyles) {
        styles = getShapeStyle(
          mergeDefaults2(formatStyles, styles),
          fillGradientDefaults4,
          fillPatternDefaults4,
          fillImageDefaults4
        );
...
var { boxPlotSeriesThemeableOptionsDef, commonSeriesOptionsDefs } = import_ag_charts_community28._ModuleSupport;
var boxPlotSeriesOptionsDef = {
  ...boxPlotSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs,
  type: (0, import_ag_charts_core13.required)((0, import_ag_charts_core13.constant)("box-plot")),
  xKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  minKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  q1Key: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  medianKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  q3Key: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  maxKey: (0, import_ag_charts_core13.required)(import_ag_charts_core13.string),
  xName: import_ag_charts_core13.string,
  yName: import_ag_charts_core13.string,
  minName: import_ag_charts_core13.string,
  q1Name: import_ag_charts_core13.string,
  medianName: import_ag_charts_core13.string,
  q3Name: import_ag_charts_core13.string,
  maxName: import_ag_charts_core13.string,
  grouped: import_ag_charts_core13.boolean,
  legendItemName: import_ag_charts_core13.string
};
...
var { CARTESIAN_AXIS_TYPE } = import_ag_charts_community29._ModuleSupport.ThemeConstants;
  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [import_ag_charts_community29._ModuleSupport.SAFE_FILL_OPERATION, { $ref: "backgroundColor" }, 0.7] }
      ]
    },
    ...
    fillPatternDefaults: import_ag_charts_community29._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community29._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 2
  },
  axes: {
...
var BoxPlotModule = {
  ...
  defaultAxes: import_ag_charts_community30._ModuleSupport.DIRECTION_SWAP_AXES,
...
var { findMinMax: findMinMax2 } = import_ag_charts_community31._ModuleSupport;
var X_MIN = 0;
var X_MAX = 1;
var Y_MIN = 2;
var Y_MAX = 3;
...
var OhlcSeriesNodeEvent = class extends import_ag_charts_community32._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends import_ag_charts_community32._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  aggregateData(dataModel, processedData) {
    ...
    if (xAxis == null || !(ContinuousScale3.is(xAxis.scale) || DiscreteTimeScale.is(xAxis.scale))) {
      return;
    }
    const xValues = dataModel.resolveKeysById(this, `xValue`, processedData);
  ...
  getItemBaseStyle(itemId, highlighted) {
    ...
    return item.fillGradientDefaults && item.fillPatternDefaults && item.fillImageDefaults ? getShapeStyle2(shapeStyle, item.fillGradientDefaults, item.fillPatternDefaults, item.fillImageDefaults) : shapeStyle;
  }
  getItemStyleOverrides(datumId, datum, itemId, format, highlighted) {
    ...
    return item.fillGradientDefaults && item.fillPatternDefaults && item.fillImageDefaults ? getShapeStyle2(overrides, item.fillGradientDefaults, item.fillPatternDefaults, item.fillImageDefaults) : overrides;
  }
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, properties } = this;
    const {
...
var { Path: Path5, SceneChangeDetection, BBox: BBox3 } = import_ag_charts_community33._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { SceneArrayChangeDetection, SceneChangeDetection: SceneChangeDetection2, ExtendedPath2D, BBox: BBox4 } = import_ag_charts_community34._ModuleSupport;
...
var { BaseProperties: BaseProperties3, Property: Property14, AbstractBarSeriesProperties: AbstractBarSeriesProperties2, SeriesTooltip: SeriesTooltip2 } = import_ag_charts_community35._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { FillGradientDefaults: FillGradientDefaults2, FillPatternDefaults: FillPatternDefaults2, FillImageDefaults: FillImageDefaults2, BaseProperties: BaseProperties4, SeriesTooltip: SeriesTooltip3, Property: Property15 } = import_ag_charts_community36._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { createDatumId: createDatumId3, isGradientFill: isGradientFill2, isPatternFill, isImageFill, getShapeFill, applyShapeStyle, getShapeStyle: getShapeStyle3 } = import_ag_charts_community37._ModuleSupport;
var CandlestickSeries = class extends OhlcSeriesBase {
  ...
  updateDatumNodes({
    ...
    datumSelection.each((node, datum) => {
      ...
      let style;
      if (itemStyler != null) {
        const { fill, fillOpacity, stroke, strokeWidth, strokeOpacity, lineDash, lineDashOffset } = isRising ? upStyle : downStyle;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs2, candlestickSeriesThemeableOptionsDef } = import_ag_charts_community38._ModuleSupport;
var candlestickSeriesOptionsDef = {
  ...candlestickSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs2,
  type: (0, import_ag_charts_core15.required)((0, import_ag_charts_core15.constant)("candlestick")),
  xKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  openKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  highKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  lowKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  closeKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  xName: import_ag_charts_core15.string,
  yName: import_ag_charts_core15.string,
  openName: import_ag_charts_core15.string,
  highName: import_ag_charts_core15.string,
  lowName: import_ag_charts_core15.string,
  closeName: import_ag_charts_core15.string
};
candlestickSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core15.undocumented)(import_ag_charts_core15.boolean);
candlestickSeriesOptionsDef.focusPriority = (0, import_ag_charts_core15.undocumented)(import_ag_charts_core15.number);
...
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE2 } = import_ag_charts_community39._ModuleSupport.ThemeConstants;
function itemTheme(key) {
  return {
    ...
    fillPatternDefaults: import_ag_charts_community39._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community39._ModuleSupport.FILL_IMAGE_DEFAULTS
  };
}
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE3, CARTESIAN_POSITION } = import_ag_charts_community40._ModuleSupport.ThemeConstants;
...
var { CachedTextMeasurerPool, TextUtils: TextUtils2, TextWrapper: TextWrapper2 } = import_ag_charts_community41._ModuleSupport;
...
function formatStackedLabels(labelValue, labelProps, secondaryLabelValue, secondaryLabelProps, { padding }, sizeFittingHeight) {
  ...
  let label;
  let secondaryLabel;
  return (0, import_ag_charts_core16.findMaxValue)(0, fontSizeCandidates.length - 1, (index) => {
...
function formatSingleLabel(value, props, { padding }, sizeFittingHeight) {
  ...
  return (0, import_ag_charts_core16.findMaxValue)(minimumFontSize, props.fontSize, (fontSize) => {
...
function formatLabels(baseLabelValue, labelProps, baseSecondaryLabelValue, secondaryLabelProps, layoutParams, sizeFittingHeight) {
  ...
  if (hasInvalidFontSize(labelProps) || hasInvalidFontSize(secondaryLabelProps)) {
    import_ag_charts_core16.Logger.warnOnce(`minimumFontSize should be set to a value less than or equal to the font size`);
  }
  let value;
...
var { Property: Property16 } = import_ag_charts_community42._ModuleSupport;
var BaseAutoSizedLabel = class extends import_ag_charts_community42._ModuleSupport.Label {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, SeriesTooltip: SeriesTooltip4, Property: Property17 } = import_ag_charts_community43._ModuleSupport;
...
} = import_ag_charts_community44._ModuleSupport;
var HeatmapSeriesNodeEvent = class extends import_ag_charts_community44._ModuleSupport.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends import_ag_charts_community44._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { dataModel, processedData } = await this.requestDataModel(dataController, this.data, {
      props: [
        ...
        ...colorKey ? [valueProperty3(colorKey, colorScaleType, { id: "colorValue", invalidValue: null })] : []
      ]
    });
  ...
  createNodeData() {
    ...
    if (xAxis.type !== "category" || yAxis.type !== "category") {
      import_ag_charts_core17.Logger.warnOnce(
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef } = import_ag_charts_community45._ModuleSupport;
var heatmapSeriesOptionsDef = {
  ...heatmapSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs3,
  type: (0, import_ag_charts_core18.required)((0, import_ag_charts_core18.constant)("heatmap")),
  xKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  yKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  colorKey: import_ag_charts_core18.string,
  xName: import_ag_charts_core18.string,
  yName: import_ag_charts_core18.string,
  colorName: import_ag_charts_core18.string,
  colorRange: (0, import_ag_charts_core18.arrayOf)(import_ag_charts_core18.color)
};
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        import_ag_charts_community46._ModuleSupport.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      enabled: false,
...
var { createDatumId: createDatumId5 } = import_ag_charts_community48._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, ohlcSeriesThemeableOptionsDef } = import_ag_charts_community49._ModuleSupport;
var ohlcSeriesOptionsDef = {
  ...ohlcSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs4,
  type: (0, import_ag_charts_core19.required)((0, import_ag_charts_core19.constant)("ohlc")),
  xKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  openKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  highKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  lowKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  closeKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  xName: import_ag_charts_core19.string,
  yName: import_ag_charts_core19.string,
  openName: import_ag_charts_core19.string,
  highName: import_ag_charts_core19.string,
  lowName: import_ag_charts_core19.string,
  closeName: import_ag_charts_core19.string
};
ohlcSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core19.undocumented)(import_ag_charts_core19.boolean);
ohlcSeriesOptionsDef.focusPriority = (0, import_ag_charts_core19.undocumented)(import_ag_charts_core19.number);

// packages/ag-charts-enterprise/src/series/ohlc/ohlcModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE5, CARTESIAN_POSITION: CARTESIAN_POSITION3 } = import_ag_charts_community50._ModuleSupport.ThemeConstants;
var OhlcModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var {
  ...
  areScalingEqual
} = import_ag_charts_community52._ModuleSupport;
...
var RangeAreaSeriesNodeEvent = class extends import_ag_charts_community53._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends import_ag_charts_community53._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
      pathsPerSeries: ["fill", "stroke"],
      pickModes: [import_ag_charts_community53._ModuleSupport.SeriesNodePickMode.AXIS_ALIGNED],
      directionKeys: {
  ...
  aggregateData(dataModel, processedData) {
    ...
    if (xAxis == null || !(ContinuousScale4.is(xAxis.scale) || DiscreteTimeScale2.is(xAxis.scale))) {
      return;
    }
    const xValues = dataModel.resolveKeysById(this, `xValue`, processedData);
  ...
  updateMarkerNodes(opts) {
    ...
    const baseStyle = mergeDefaults3(highlighted && this.properties.highlightStyle.item, marker.getStyle(), {
      fill,
      fillOpacity,
      stroke,
      strokeWidth,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs5, rangeAreaSeriesThemeableOptionsDef } = import_ag_charts_community54._ModuleSupport;
var rangeAreaSeriesOptionsDef = {
  ...rangeAreaSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs5,
  type: (0, import_ag_charts_core20.required)((0, import_ag_charts_core20.constant)("range-area")),
  xKey: (0, import_ag_charts_core20.required)(import_ag_charts_core20.string),
  yLowKey: (0, import_ag_charts_core20.required)(import_ag_charts_core20.string),
  yHighKey: (0, import_ag_charts_core20.required)(import_ag_charts_core20.string),
  xName: import_ag_charts_core20.string,
  yName: import_ag_charts_core20.string,
  yLowName: import_ag_charts_core20.string,
  yHighName: import_ag_charts_core20.string
};
rangeAreaSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core20.undocumented)(import_ag_charts_core20.boolean);
rangeAreaSeriesOptionsDef.focusPriority = (0, import_ag_charts_core20.undocumented)(import_ag_charts_core20.number);
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community55._ModuleSupport.FILL_PATTERN_DEFAULTS,
    stroke: { $palette: "stroke" },
    fillOpacity: 0.7,
    ...
    marker: {
      ...
      fillPatternDefaults: import_ag_charts_community55._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community55._ModuleSupport.FILL_IMAGE_DEFAULTS,
      size: 6,
      strokeWidth: 2
    },
    label: {
  ...
  axes: {
    [import_ag_charts_community55._ModuleSupport.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
var RangeBarSeriesNodeEvent = class extends import_ag_charts_community58._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends import_ag_charts_community58._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  aggregateData(dataModel, processedData) {
    ...
    if (xAxis == null || !(ContinuousScale5.is(xAxis.scale) || DiscreteTimeScale3.is(xAxis.scale))) {
      return;
    }
    const xValues = dataModel.resolveKeysById(this, `xValue`, processedData);
    const yHighValues = dataModel.resolveColumnById(this, `yHighValue`, processedData);
  ...
  animateWaitingUpdateReady(data) {
    ...
    const dataDiff = import_ag_charts_community58._ModuleSupport.calculateDataDiff(
      this.id,
      datumSelections,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, rangeBarSeriesThemeableOptionsDef } = import_ag_charts_community59._ModuleSupport;
var rangeBarSeriesOptionsDef = {
  ...rangeBarSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs6,
  type: (0, import_ag_charts_core21.required)((0, import_ag_charts_core21.constant)("range-bar")),
  xKey: (0, import_ag_charts_core21.required)(import_ag_charts_core21.string),
  yLowKey: (0, import_ag_charts_core21.required)(import_ag_charts_core21.string),
  yHighKey: (0, import_ag_charts_core21.required)(import_ag_charts_core21.string),
  xName: import_ag_charts_core21.string,
  yName: import_ag_charts_core21.string,
  yLowName: import_ag_charts_core21.string,
  yHighName: import_ag_charts_core21.string
};
rangeBarSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core21.undocumented)(import_ag_charts_core21.boolean);
rangeBarSeriesOptionsDef.fastDataProcessing = (0, import_ag_charts_core21.undocumented)(import_ag_charts_core21.boolean);
rangeBarSeriesOptionsDef.focusPriority = (0, import_ag_charts_core21.undocumented)(import_ag_charts_core21.number);
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community60._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community60._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
  ...
  axes: {
    [import_ag_charts_community60._ModuleSupport.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: { enabled: true }
    }
  }
};
...
var RangeBarModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: import_ag_charts_community61._ModuleSupport.DIRECTION_SWAP_AXES,
...
var {
  ...
  Label: Label3
} = import_ag_charts_community62._ModuleSupport;
...
var WaterfallSeries = class extends import_ag_charts_community63._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    if (!this.visible)
      return;
    const positiveNumber4 = (v) => isContinuous(v) && Number(v) >= 0;
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        valueProperty6("totalType", "band", {
          id: `totalTypeValue`,
          missingValue: void 0,
          validation: totalTypeValue
        }),
        ...isContinuousX ? [import_ag_charts_community63._ModuleSupport.SMALLEST_KEY_INTERVAL, import_ag_charts_community63._ModuleSupport.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: import_ag_charts_community63._ModuleSupport.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: import_ag_charts_community63._ModuleSupport.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, waterfallSeriesThemeableOptionsDef } = import_ag_charts_community64._ModuleSupport;
var waterfallSeriesOptionsDef = {
  ...waterfallSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs7,
  type: (0, import_ag_charts_core22.required)((0, import_ag_charts_core22.constant)("waterfall")),
  xKey: (0, import_ag_charts_core22.required)(import_ag_charts_core22.string),
  yKey: (0, import_ag_charts_core22.required)(import_ag_charts_core22.string),
  xName: import_ag_charts_core22.string,
  yName: import_ag_charts_core22.string,
  totals: (0, import_ag_charts_core22.arrayOfDefs)(
    {
      totalType: (0, import_ag_charts_core22.required)((0, import_ag_charts_core22.union)("total", "subtotal")),
      index: (0, import_ag_charts_core22.required)(import_ag_charts_core22.positiveNumber),
      axisLabel: (0, import_ag_charts_core22.required)(import_ag_charts_core22.string)
    },
...
function itemTheme2(key, index) {
  return {
    ...
    fillPatternDefaults: import_ag_charts_community65._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community65._ModuleSupport.FILL_IMAGE_DEFAULTS,
...
var WaterfallModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: import_ag_charts_community66._ModuleSupport.DIRECTION_SWAP_AXES,
...
var {
  ...
  without
} = import_ag_charts_community67._ModuleSupport;
var navigatorHandleOptionsDef = {
  width: import_ag_charts_core23.positiveNumber,
  height: import_ag_charts_core23.positiveNumber,
  grip: import_ag_charts_core23.boolean,
  fill: import_ag_charts_core23.color,
  stroke: import_ag_charts_core23.color,
  strokeWidth: import_ag_charts_core23.positiveNumber,
  cornerRadius: import_ag_charts_core23.positiveNumber
};
...
var navigatorOptionsDef = {
  enabled: import_ag_charts_core23.boolean,
  height: import_ag_charts_core23.positiveNumber,
  spacing: import_ag_charts_core23.positiveNumber,
  cornerRadius: import_ag_charts_core23.number,
  mask: {
    fill: import_ag_charts_core23.color,
    fillOpacity: import_ag_charts_core23.ratio,
    stroke: import_ag_charts_core23.color,
    strokeWidth: import_ag_charts_core23.positiveNumber
  },
  ...
  miniChart: {
    enabled: import_ag_charts_core23.boolean,
    padding: {
      top: import_ag_charts_core23.positiveNumber,
      bottom: import_ag_charts_core23.positiveNumber
    },
    label: {
      enabled: import_ag_charts_core23.boolean,
      avoidCollisions: import_ag_charts_core23.boolean,
      spacing: import_ag_charts_core23.positiveNumber,
      format: numberFormatValidator,
      formatter: import_ag_charts_core23.callback,
      interval: {
        minSpacing: import_ag_charts_core23.positiveNumber,
        maxSpacing: import_ag_charts_core23.positiveNumber,
        values: import_ag_charts_core23.array,
        step: import_ag_charts_core23.number
      },
      ...import_ag_charts_core23.fontOptionsDef
    },
    series: (0, import_ag_charts_core23.arrayOfDefs)(
      (0, import_ag_charts_core23.typeUnion)(
        {
...
// packages/ag-charts-enterprise/src/features/sync/pluginModules.ts
var { annotationOptionsDef } = import_ag_charts_community68._ModuleSupport;
...
function removeCircularLinks(links) {
  ...
  if (circularLinks.size !== 0) {
    import_ag_charts_core24.Logger.warnOnce("Some links formed circular references. These will be removed from the output.");
  }
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection4, Group: Group6, TransformableText } = import_ag_charts_community69._ModuleSupport;
var FlowProportionSeriesNodeEvent = class extends import_ag_charts_community69._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var { Path: Path6, SceneChangeDetection: SceneChangeDetection3 } = import_ag_charts_community70._ModuleSupport;
...
var {
  ...
  Property: Property21,
  Label: Label4
} = import_ag_charts_community71._ModuleSupport;
  ...
  createNodeData() {
    ...
    if (this.isLabelEnabled()) {
      ...
      nodeGraph.forEach(({ datum: node }) => {
        ...
        const { width } = CachedTextMeasurerPool2.measureText(text, {
          font: canvasFont,
          textAlign: "left",
          textBaseline: "middle"
        });
    ...
    if (nodeCount * spacingSweep >= 2 * Math.PI || radius <= 0) {
      import_ag_charts_core25.Logger.warnOnce("There was insufficient space to display the Chord Series.");
      return;
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, chordSeriesThemeableOptionsDef } = import_ag_charts_community73._ModuleSupport;
var chordSeriesOptionsDef = {
  ...chordSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs8,
  type: (0, import_ag_charts_core26.required)((0, import_ag_charts_core26.constant)("chord")),
  fromKey: (0, import_ag_charts_core26.required)(import_ag_charts_core26.string),
  toKey: (0, import_ag_charts_core26.required)(import_ag_charts_core26.string),
  sizeKey: import_ag_charts_core26.string,
  sizeName: import_ag_charts_core26.string
};
chordSeriesOptionsDef.fillGradientDefaults = (0, import_ag_charts_core26.undocumented)(import_ag_charts_core26.fillGradientDefaults);
chordSeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core26.undocumented)(import_ag_charts_core26.fillPatternDefaults);
chordSeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core26.undocumented)(import_ag_charts_core26.fillImageDefaults);
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community74._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community74._ModuleSupport.FILL_IMAGE_DEFAULTS,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
} = import_ag_charts_community75._ModuleSupport;
...
var FUNNEL_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community75._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community75._ModuleSupport.FILL_IMAGE_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
...
var { lineDistanceSquared, BBox: BBox7, Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = import_ag_charts_community76._ModuleSupport;
var delta = 1e-6;
...
var { NODE_UPDATE_STATE_TO_PHASE_MAPPING } = import_ag_charts_community77._ModuleSupport;
...
var FunnelSeriesNodeEvent = class extends import_ag_charts_community78._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var BaseFunnelSeries = class extends import_ag_charts_community78._ModuleSupport.AbstractBarSeries {
  constructor({
    moduleCtx,
    animationResetFns
  }) {
  ...
  createNodeData() {
    ...
    const yValues = dataModel.resolveColumnById(this, `yValue`, processedData);
    const { barWidth, groupIndex } = this.updateGroupScale(xAxis);
    const barOffset = ContinuousScale6.is(xScale) ? barWidth * -0.5 : 0;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { formatValue, Line: Line4 } = import_ag_charts_community80._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef } = import_ag_charts_community81._ModuleSupport;
var coneFunnelSeriesOptionsDef = {
  ...coneFunnelSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs9,
  type: (0, import_ag_charts_core27.required)((0, import_ag_charts_core27.constant)("cone-funnel")),
  stageKey: (0, import_ag_charts_core27.required)(import_ag_charts_core27.string),
  valueKey: (0, import_ag_charts_core27.required)(import_ag_charts_core27.string)
};
  ...
  series: {
    ...
    fills: {
      $if: [
        ...
        import_ag_charts_community82._ModuleSupport.SAFE_RANGE2_OPERATION
      ]
    },
    strokes: {
      $if: [
    ...
    fillPatternDefaults: import_ag_charts_community82._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community82._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
...
} = import_ag_charts_community85._ModuleSupport;
var FunnelSeries = class extends BaseFunnelSeries {
  ...
  updateDatumNodes(opts) {
    ...
    const { datumSelection, isHighlight } = opts;
    const categoryAlongX = this.getCategoryDirection() === ChartAxisDirection13.X;
    const style = this.getItemBaseStyle(isHighlight);
    const fillBBox = this.getShapeFillBBox();
    datumSelection.each((rect, datum) => {
      const { datumIndex } = datum;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef } = import_ag_charts_community86._ModuleSupport;
var funnelSeriesOptionsDef = {
  ...funnelSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs10,
  type: (0, import_ag_charts_core28.required)((0, import_ag_charts_core28.constant)("funnel")),
  stageKey: (0, import_ag_charts_core28.required)(import_ag_charts_core28.string),
  valueKey: (0, import_ag_charts_core28.required)(import_ag_charts_core28.string)
};
...
function formatWithContext(ctx, formatter, params) {
  return import_ag_charts_community88._ModuleSupport.callWithContext(ctx.chartService, void 0, formatter, [params]);
}
...
function pickGaugeNearestDatum(self, point) {
  const it = (0, import_ag_charts_core29.iterate)(self.datumUnion.nodes(), self.targetSelection.nodes());
...
function pickGaugeFocus(self, opts) {
  ...
  const otherIndex = (0, import_ag_charts_core29.clamp)(0, opts.otherIndex + opts.otherIndexDelta, others.length - 1);
  if (others.length === 0)
    return;
  const { data, selection } = others[otherIndex];
  if (data == null || data.length === 0)
    return;
  const datumIndex = (0, import_ag_charts_core29.clamp)(0, opts.datumIndex, data.length - 1);
...
var { BaseProperties: BaseProperties8, Property: Property24 } = import_ag_charts_community91._ModuleSupport;
var GaugeSegmentationIntervalProperties = class extends BaseProperties8 {
  getSegments(scale, maxTicks) {
    ...
    if (ticks != null && ticks.length > maxTicks) {
      import_ag_charts_core30.Logger.warnOnce(
...
// packages/ag-charts-enterprise/src/series/linear-gauge/linearGaugeSeriesProperties.ts
var { BaseProperties: BaseProperties9, SeriesTooltip: SeriesTooltip11, SeriesProperties: SeriesProperties2, PropertiesArray: PropertiesArray2, Property: Property25, Label: Label7, AxisLabel: AxisLabel3 } = import_ag_charts_community92._ModuleSupport;
...
var LinearGaugeBarProperties = class extends BaseProperties9 {
  constructor() {
    ...
    this.fills = new PropertiesArray2(import_ag_charts_community92._ModuleSupport.StopProperties);
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox8 } = import_ag_charts_community93._ModuleSupport;
...
var {
  ...
  getColorStops,
  findRangeExtent
} = import_ag_charts_community94._ModuleSupport;
...
var LinearGaugeSeries = class extends import_ag_charts_community94._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
    ...
    this.originX = 0;
    this.originY = 0;
    this.scaleGroup = this.contentGroup.appendChild(new Group8({ name: "scaleGroup" }));
    this.itemGroup = this.contentGroup.appendChild(new Group8({ name: "itemGroup" }));
    this.itemTargetGroup = this.contentGroup.appendChild(new Group8({ name: "itemTargetGroup" }));
    this.itemTargetLabelGroup = this.contentGroup.appendChild(new Group8({ name: "itemTargetLabelGroup" }));
    this.itemLabelGroup = this.contentGroup.appendChild(new Group8({ name: "itemLabelGroup" }));
    this.highlightTargetGroup = this.highlightGroup.appendChild(
      new Group8({ name: "itemTargetLabelGroup" })
    );
    this.tickGroup = this.contentGroup.appendChild(new Group8({ name: "tickGroup" }));
  ...
  horizontalLabelInset() {
    ...
    const labelSize = linesOrTicks.reduce((accum, text) => {
      const { width } = CachedTextMeasurerPool4.measureText(text, { font });
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      rect.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community94._ModuleSupport.PointerEvents.All : import_ag_charts_community94._ModuleSupport.PointerEvents.None;
      if (animationDisabled || rect.previousDatum == null) {
        rect.setProperties(resetLinearGaugeSeriesResetRectFunction(rect, datum));
      }
    });
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community94._ModuleSupport.Rect, (node, first, last) => {
      node.pointerEvents = import_ag_charts_community94._ModuleSupport.PointerEvents.None;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          import_ag_charts_community95._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["./2", import_ag_charts_community95._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          spacing: 11
        }
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: import_ag_charts_community95._ModuleSupport.linearGaugeSeriesOptionsDef,
...
var { LonLatBBox } = import_ag_charts_community96._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox10, SceneChangeDetection: SceneChangeDetection5, SceneObjectChangeDetection, objectsEqual } = import_ag_charts_community97._ModuleSupport;
...
var TopologySeriesProperties = class extends import_ag_charts_community98._ModuleSupport.SeriesProperties {
};
var TopologySeries = class extends import_ag_charts_community98._ModuleSupport.DataModelSeries {
...
var { Property: Property26, SeriesProperties: SeriesProperties3, SeriesTooltip: SeriesTooltip12, Label: Label8 } = import_ag_charts_community99._ModuleSupport;
...
} = import_ag_charts_community100._ModuleSupport;
var MapLineSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      import_ag_charts_core31.Logger.warnOnce(`no topology was provided for [MapLineSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  getLabelDatum(datum, labelValue, projectedGeometry, font) {
    ...
    if (labelText == null)
      return;
    const labelSize = CachedTextMeasurerPool5.measureText(String(labelText), { font });
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core31.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community100._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without2 } = import_ag_charts_community101._ModuleSupport;
var mapLineSeriesOptionsDef = {
  ...mapLineSeriesThemeableOptionsDef,
  ...without2(commonSeriesOptionsDefs11, ["highlightStyle"]),
  type: (0, import_ag_charts_core32.required)((0, import_ag_charts_core32.constant)("map-line")),
  idKey: (0, import_ag_charts_core32.required)(import_ag_charts_core32.string),
  sizeKey: import_ag_charts_core32.string,
  colorKey: import_ag_charts_core32.string,
  labelKey: import_ag_charts_core32.string,
  idName: import_ag_charts_core32.string,
  sizeName: import_ag_charts_core32.string,
  colorName: import_ag_charts_core32.string,
  labelName: import_ag_charts_core32.string,
  topology: import_ag_charts_core32.geoJson,
  topologyIdKey: import_ag_charts_core32.string,
  legendItemName: import_ag_charts_core32.string,
  title: import_ag_charts_core32.string
};
mapLineSeriesOptionsDef.colorRange = (0, import_ag_charts_core32.undocumented)((0, import_ag_charts_core32.and)((0, import_ag_charts_core32.arrayOf)(import_ag_charts_core32.color), (0, import_ag_charts_core32.arrayLength)(1)));
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: import_ag_charts_community102._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          import_ag_charts_community102._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
...
var { Property: Property27, SeriesProperties: SeriesProperties4, SeriesTooltip: SeriesTooltip13 } = import_ag_charts_community103._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId14, SeriesNodePickMode: SeriesNodePickMode10, Group: Group9, Selection: Selection8, PointerEvents: PointerEvents6 } = import_ag_charts_community104._ModuleSupport;
var MapLineBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      import_ag_charts_core33.Logger.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community105._ModuleSupport;
var mapLineBackgroundSeriesOptionsDef = {
  ...mapLineBackgroundSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core34.required)((0, import_ag_charts_core34.constant)("map-line-background")),
  topology: import_ag_charts_core34.geoJson
};
...
var { BBox: BBox11 } = import_ag_charts_community107._ModuleSupport;
...
var MapMarkerSeries = class extends TopologySeries {
  constructor(moduleCtx) {
    ...
    this.markerGroup = this.contentGroup.appendChild(new Group10({ name: "markerGroup" }));
    ...
    this.highlightMarkerSelection = Selection9.select(this.highlightNode, Marker2);
  ...
  getLabelDatum(datum, labelValue, x, y, size, font) {
    ...
    if (labelText == null)
      return;
    const { width, height } = CachedTextMeasurerPool6.measureText(String(labelText), { font });
    const anchor = Marker2.anchor(shape);
    return {
      point: { x, y, size },
      label: { width, height, text: labelText },
      anchor,
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core35.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community109._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without3 } = import_ag_charts_community110._ModuleSupport;
var mapMarkerSeriesOptionsDef = {
  ...mapMarkerSeriesThemeableOptionsDef,
  ...without3(commonSeriesOptionsDefs12, ["highlightStyle"]),
  type: (0, import_ag_charts_core36.required)((0, import_ag_charts_core36.constant)("map-marker")),
  idKey: import_ag_charts_core36.string,
  latitudeKey: import_ag_charts_core36.string,
  longitudeKey: import_ag_charts_core36.string,
  sizeKey: import_ag_charts_core36.string,
  colorKey: import_ag_charts_core36.string,
  labelKey: import_ag_charts_core36.string,
  idName: import_ag_charts_core36.string,
  latitudeName: import_ag_charts_core36.string,
  longitudeName: import_ag_charts_core36.string,
  sizeName: import_ag_charts_core36.string,
  colorName: import_ag_charts_core36.string,
  labelName: import_ag_charts_core36.string,
  topology: import_ag_charts_core36.geoJson,
  topologyIdKey: import_ag_charts_core36.string,
  legendItemName: import_ag_charts_core36.string,
  title: import_ag_charts_core36.string
};
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          import_ag_charts_community111._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: import_ag_charts_community111._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community111._ModuleSupport.FILL_IMAGE_DEFAULTS,
      fillOpacity: 0.5,
      label: {
        enabled: false,
        fontSize: { $ref: "fontSize" },
...
var MapMarkerSeriesModule = {
  ...
  validate(options, optionsDefs2, path) {
    const result = (0, import_ag_charts_core37.validate)(options, optionsDefs2, path);
    ...
    if (cleared?.idKey == null && (cleared?.latitudeKey == null || cleared?.longitudeKey == null)) {
      ...
      invalid.push(new import_ag_charts_core37.ValidationError("required", message, null, path));
    }
    return result;
  }
};
...
var { Property: Property29, SeriesProperties: SeriesProperties6, SeriesTooltip: SeriesTooltip15, FillGradientDefaults: FillGradientDefaults10, FillPatternDefaults: FillPatternDefaults10, FillImageDefaults: FillImageDefaults10 } = import_ag_charts_community112._ModuleSupport;
...
var fixedScale = import_ag_charts_community113._ModuleSupport.MercatorScale.fixedScale();
var MapShapeSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      import_ag_charts_core38.Logger.warnOnce(`no topology was provided for [MapShapeSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  getLabelLayout(datum, labelValue, font, geometry, previousLabelLayout) {
    ...
    if (labelText == null)
      return;
    const baseSize = CachedTextMeasurerPool7.measureText(String(labelText), { font });
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core38.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without4 } = import_ag_charts_community114._ModuleSupport;
var mapShapeSeriesOptionsDef = {
  ...mapShapeSeriesThemeableOptionsDef,
  ...without4(commonSeriesOptionsDefs13, ["highlightStyle"]),
  type: (0, import_ag_charts_core39.required)((0, import_ag_charts_core39.constant)("map-shape")),
  idKey: (0, import_ag_charts_core39.required)(import_ag_charts_core39.string),
  colorKey: import_ag_charts_core39.string,
  labelKey: import_ag_charts_core39.string,
  idName: import_ag_charts_core39.string,
  colorName: import_ag_charts_core39.string,
  labelName: import_ag_charts_core39.string,
  topology: import_ag_charts_core39.geoJson,
  topologyIdKey: import_ag_charts_core39.string,
  legendItemName: import_ag_charts_core39.string,
  title: import_ag_charts_core39.string
};
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          import_ag_charts_community115._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: import_ag_charts_community115._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community115._ModuleSupport.FILL_IMAGE_DEFAULTS,
      fillOpacity: 1,
      strokeWidth: 1,
      lineDash: [0],
      lineDashOffset: 0,
...
var { FillGradientDefaults: FillGradientDefaults11, FillPatternDefaults: FillPatternDefaults11, FillImageDefaults: FillImageDefaults11, Property: Property30, SeriesProperties: SeriesProperties7, SeriesTooltip: SeriesTooltip16 } = import_ag_charts_community116._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId17, SeriesNodePickMode: SeriesNodePickMode13, Selection: Selection11, Group: Group12, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle12 } = import_ag_charts_community117._ModuleSupport;
var MapShapeBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      import_ag_charts_core40.Logger.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
    const { id: seriesId, topology, scale } = this;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community118._ModuleSupport;
var mapShapeBackgroundSeriesOptionsDef = {
  ...mapShapeBackgroundSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs14,
  type: (0, import_ag_charts_core41.required)((0, import_ag_charts_core41.constant)("map-shape-background")),
  topology: import_ag_charts_core41.geoJson
};
...
var MapShapeBackgroundModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: {
        ...import_ag_charts_community119._ModuleSupport.FILL_PATTERN_DEFAULTS,
        fill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        stroke: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] }
      },
      fillImageDefaults: import_ag_charts_community119._ModuleSupport.FILL_IMAGE_DEFAULTS
    }
  }
};
...
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community120._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community120._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  async processData(dataController) {
    ...
    const extraProps = [];
    if ((0, import_ag_charts_core42.isDefined)(normalizedTo)) {
    ...
    const visibleProps = this.visible ? {} : { forceValue: 0 };
    const radiusScaleType = this.axes[ChartAxisDirection14.Radius]?.scale.type;
    const angleScaleType = this.axes[ChartAxisDirection14.Angle]?.scale.type;
  ...
  isRadiusAxisReversed() {
    return this.axes[ChartAxisDirection14.Radius]?.isReversed();
  }
  ...
  getAxisInnerRadius() {
    const radiusAxis = this.axes[ChartAxisDirection14.Radius];
  ...
  createNodeData() {
    ...
    if (!dataModel || !processedData || processedData.type !== "grouped")
      return;
    const angleAxis = this.axes[ChartAxisDirection14.Angle];
    const radiusAxis = this.axes[ChartAxisDirection14.Radius];
  ...
  updateSectorSelection(selection, highlighted) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const itemBounds = isGradientFill3(fill) && fill.bounds === "item";
  ...
  getTooltipContent(datumIndex) {
    ...
    const angleAxis = axes[ChartAxisDirection14.Angle];
    const radiusAxis = axes[ChartAxisDirection14.Radius];
  ...
  legendItemSymbol() {
    ...
    if (import_ag_charts_community120._ModuleSupport.isGradientFill(markerStyle.fill)) {
...
var { motion: motion7 } = import_ag_charts_community122._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = import_ag_charts_community123._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = import_ag_charts_community124._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = import_ag_charts_community125._ModuleSupport;
var nightingaleSeriesOptionsDef = {
  ...nightingaleSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs15,
  type: (0, import_ag_charts_core43.required)((0, import_ag_charts_core43.constant)("nightingale")),
  angleKey: (0, import_ag_charts_core43.required)(import_ag_charts_core43.string),
  radiusKey: (0, import_ag_charts_core43.required)(import_ag_charts_core43.string),
  angleName: import_ag_charts_core43.string,
  radiusName: import_ag_charts_core43.string,
  grouped: import_ag_charts_core43.boolean,
  stacked: import_ag_charts_core43.boolean,
  stackGroup: import_ag_charts_core43.string,
  normalizedTo: import_ag_charts_core43.number
};
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community126._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community126._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 1,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
...
var PyramidSeries = class extends import_ag_charts_community129._ModuleSupport.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
    ...
    this.itemLabelGroup = this.contentGroup.appendChild(new Group13({ name: "itemLabelGroup" }));
    this.stageLabelGroup = this.contentGroup.appendChild(new Group13({ name: "stageLabelGroup" }));
  ...
  createNodeData() {
    ...
    const xValues = dataModel.resolveColumnById(this, `xValue`, processedData);
    const yValues = dataModel.resolveColumnById(this, `yValue`, processedData);
    const textMeasurer = CachedTextMeasurerPool8.getMeasurer({ font: stageLabel.getFont() });
    let textAlign;
    let textBaseline;
    if (horizontal) {
      textAlign = "center";
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = import_ag_charts_community130._ModuleSupport;
var pyramidSeriesOptionsDef = {
  ...pyramidSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs16,
  type: (0, import_ag_charts_core44.required)((0, import_ag_charts_core44.constant)("pyramid")),
  stageKey: (0, import_ag_charts_core44.required)(import_ag_charts_core44.string),
  valueKey: (0, import_ag_charts_core44.required)(import_ag_charts_core44.string)
};
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community131._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community131._ModuleSupport.FILL_IMAGE_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
...
} = import_ag_charts_community133._ModuleSupport;
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      fillPatternDefaults: import_ag_charts_community133._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community133._ModuleSupport.FILL_IMAGE_DEFAULTS,
      fillOpacity: 1,
      shape: "circle",
      size: 6,
      strokeOpacity: 1,
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community133._ModuleSupport.mergeDefaults(
  {
    series: {
      stroke: import_ag_charts_community133._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = import_ag_charts_community133._ModuleSupport.mergeDefaults(
  {
    series: {
      fill: { $palette: "fill" },
      fillGradientDefaults: {
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, SeriesTooltip: SeriesTooltip19, Property: Property33 } = import_ag_charts_community134._ModuleSupport;
...
var RadarSeriesNodeEvent = class extends import_ag_charts_community135._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community135._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
    ...
    this.lineGroup = this.contentGroup.appendChild(new Group14({ name: "radar-line" }));
  ...
  createNodeData() {
    ...
    const angleScale = this.axes[ChartAxisDirection15.Angle]?.scale;
    const radiusScale = this.axes[ChartAxisDirection15.Radius]?.scale;
    if (!angleScale || !radiusScale) {
      return;
    }
    ...
    const nodeData = rawData.map((datum, datumIndex) => {
      ...
      if (label.enabled) {
        ...
        if (labelText) {
          let textAlign = "right";
          if ((0, import_ag_charts_core45.isNumberEqual)(cos, 0)) {
            textAlign = "center";
          } else if (cos > 0) {
            textAlign = "left";
          }
          let textBaseline = "bottom";
          if ((0, import_ag_charts_core45.isNumberEqual)(sin, 0)) {
            textBaseline = "middle";
          } else if (sin > 0) {
            textBaseline = "top";
          }
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !(0, import_ag_charts_core45.isFiniteNumber)(angle) || !(0, import_ag_charts_core45.isFiniteNumber)(radius)
      };
    });
    return { itemId: radiusKey, nodeData, labelData: nodeData };
  }
  ...
  updateMarkers(selection, highlight) {
    ...
    const baseStyle = mergeDefaults4(highlight && highlightStyle.item, marker.getStyle(), {
      stroke,
      strokeWidth,
      strokeOpacity
    });
...
var { FillGradientDefaults: FillGradientDefaults14, FillPatternDefaults: FillPatternDefaults14, FillImageDefaults: FillImageDefaults14, Property: Property34 } = import_ag_charts_community136._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group15, Path: Path10, PointerEvents: PointerEvents11, Selection: Selection14, ChartAxisDirection: ChartAxisDirection16, applyShapeStyle: applyShapeStyle13, getShapeFill: getShapeFill4, getShapeStyle: getShapeStyle16 } = import_ag_charts_community137._ModuleSupport;
var RadarAreaSeries = class extends RadarSeries {
  constructor(moduleCtx) {
    super(moduleCtx);
    this.properties = new RadarAreaSeriesProperties();
    this.areaGroup = this.contentGroup.appendChild(new Group15({ name: "radar-area" }));
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community137._ModuleSupport.PolarAxis ? axis : void 0;
    };
    const radiusAxis = getPolarAxis(ChartAxisDirection16.Radius);
    const angleAxis = getPolarAxis(ChartAxisDirection16.Angle);
    const reversedRadiusAxis = radiusAxis?.isReversed();
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = import_ag_charts_community138._ModuleSupport;
var radarAreaSeriesOptionsDef = {
  ...radarAreaSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs17,
  type: (0, import_ag_charts_core46.required)((0, import_ag_charts_core46.constant)("radar-area")),
  angleKey: (0, import_ag_charts_core46.required)(import_ag_charts_core46.string),
  radiusKey: (0, import_ag_charts_core46.required)(import_ag_charts_core46.string),
  angleName: import_ag_charts_core46.string,
  radiusName: import_ag_charts_core46.string
};

// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var {
  ThemeConstants: { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE4 }
} = import_ag_charts_community139._ModuleSupport;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = import_ag_charts_community140._ModuleSupport;
var radarLineSeriesOptionsDef = {
  ...radarLineSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs18,
  type: (0, import_ag_charts_core47.required)((0, import_ag_charts_core47.constant)("radar-line")),
  angleKey: (0, import_ag_charts_core47.required)(import_ag_charts_core47.string),
  radiusKey: (0, import_ag_charts_core47.required)(import_ag_charts_core47.string),
  angleName: import_ag_charts_core47.string,
  radiusName: import_ag_charts_core47.string
};

// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = import_ag_charts_community141._ModuleSupport.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var {
  ...
  Property: Property35,
  Label: Label13
} = import_ag_charts_community142._ModuleSupport;
...
var { SectorBox: SectorBox3, motion: motion9 } = import_ag_charts_community143._ModuleSupport;
...
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community144._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community144._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  get defaultShapeStyle() {
    const angleScale = this.axes[ChartAxisDirection17.Angle]?.scale;
    return {
      ...this.properties.fillGradientDefaults.toJson(),
      rotation: import_ag_charts_community144._ModuleSupport.toDegrees(angleScale.range[0]) + 90
    };
  }
  nodeFactory() {
    return new Sector5();
  ...
  getSeriesDomain(direction) {
    ...
    if (!processedData || !dataModel)
      return [];
    if (direction === ChartAxisDirection17.Angle) {
  ...
  async processData(dataController) {
    ...
    const stackGroupTrailingId = `${stackGroupId}-trailing`;
    const extraProps = [];
    if ((0, import_ag_charts_core48.isDefined)(normalizedTo)) {
    ...
    const visibleProps = this.visible ? {} : { forceValue: 0 };
    const radiusScaleType = this.axes[ChartAxisDirection17.Radius]?.scale.type;
    const angleScaleType = this.axes[ChartAxisDirection17.Angle]?.scale.type;
    await this.requestDataModel(dataController, this.data, {
      props: [
  ...
  updateSectorSelection(selection, highlighted) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = overrides?.fill ?? style.fill;
      const fillParams = import_ag_charts_community144._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
  ...
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, axes, properties } = this;
    const { angleKey, angleName, radiusKey, radiusName, tooltip } = properties;
    const angleAxis = axes[ChartAxisDirection17.Angle];
    const radiusAxis = axes[ChartAxisDirection17.Radius];
    if (!dataModel || !processedData || !angleAxis || !radiusAxis)
      return;
    const datum = processedData.dataSources.get(this.id)?.[datumIndex];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = import_ag_charts_community145._ModuleSupport;
var radialBarSeriesOptionsDef = {
  ...radialBarSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs19,
  type: (0, import_ag_charts_core49.required)((0, import_ag_charts_core49.constant)("radial-bar")),
  angleKey: (0, import_ag_charts_core49.required)(import_ag_charts_core49.string),
  radiusKey: (0, import_ag_charts_core49.required)(import_ag_charts_core49.string),
  angleName: import_ag_charts_core49.string,
  radiusName: import_ag_charts_core49.string,
  grouped: import_ag_charts_core49.boolean,
  stacked: import_ag_charts_core49.boolean,
  stackGroup: import_ag_charts_core49.string,
  normalizedTo: import_ag_charts_core49.number
};
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: import_ag_charts_community146._ModuleSupport.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: import_ag_charts_community146._ModuleSupport.FILL_IMAGE_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = import_ag_charts_community147._ModuleSupport.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property36 } = import_ag_charts_community148._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection18, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community149._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = import_ag_charts_community150._ModuleSupport;
var radialColumnSeriesOptionsDef = {
  ...radialColumnSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs20,
  type: (0, import_ag_charts_core50.required)((0, import_ag_charts_core50.constant)("radial-column")),
  angleKey: (0, import_ag_charts_core50.required)(import_ag_charts_core50.string),
  radiusKey: (0, import_ag_charts_core50.required)(import_ag_charts_core50.string),
  angleName: import_ag_charts_core50.string,
  radiusName: import_ag_charts_core50.string,
  grouped: import_ag_charts_core50.boolean,
  stacked: import_ag_charts_core50.boolean,
  stackGroup: import_ag_charts_core50.string,
  normalizedTo: import_ag_charts_core50.number
};
...
} = import_ag_charts_community151._ModuleSupport;
var axisShape2 = {
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = import_ag_charts_community152._ModuleSupport.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable } = import_ag_charts_community153._ModuleSupport;
...
var { BaseProperties: BaseProperties10, SeriesTooltip: SeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property37, Label: Label14 } = import_ag_charts_community154._ModuleSupport;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(import_ag_charts_community154._ModuleSupport.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = import_ag_charts_community155._ModuleSupport;
...
var RadialGaugeSeries = class extends import_ag_charts_community156._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
    ...
    this.scaleGroup = this.contentGroup.appendChild(new Group16({ name: "scaleGroup" }));
    this.itemGroup = this.contentGroup.appendChild(new Group16({ name: "itemGroup" }));
    this.itemNeedleGroup = this.contentGroup.appendChild(new Group16({ name: "itemNeedleGroup" }));
    this.itemTargetGroup = this.contentGroup.appendChild(new Group16({ name: "itemTargetGroup" }));
    this.itemTargetLabelGroup = this.contentGroup.appendChild(new Group16({ name: "itemTargetLabelGroup" }));
    this.itemLabelGroup = this.contentGroup.appendChild(new Group16({ name: "itemLabelGroup" }));
    this.highlightTargetGroup = this.highlightGroup.appendChild(
      new Group16({ name: "itemTargetLabelGroup" })
    );
    this.tickGroup = this.contentGroup.appendChild(new Group16({ name: "tickGroup" }));
    ...
    this.tickSelection = Selection15.select(this.tickGroup, import_ag_charts_community156._ModuleSupport.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const fractionDigits = ticks.reduce(
      (f, tick) => Math.max(f, typeof tick === "number" ? (0, import_ag_charts_core52.countFractionDigits)(tick) : 0),
      0
    );
    ...
    const tickData = ticks.map((value, index) => {
      ...
      const { width, height } = CachedTextMeasurerPool9.measureText(text, { font });
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community156._ModuleSupport.PointerEvents.All : import_ag_charts_community156._ModuleSupport.PointerEvents.None;
      sector.fill = fill;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community156._ModuleSupport.Sector, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community156._ModuleSupport.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = import_ag_charts_community157._ModuleSupport;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          import_ag_charts_community157._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["./2", import_ag_charts_community157._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          fontWeight: { $ref: "fontWeight" },
          fontSize: { $ref: "fontSize" },
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: import_ag_charts_community157._ModuleSupport.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path11, SceneChangeDetection: SceneChangeDetection6, splitBezier } = import_ag_charts_community158._ModuleSupport;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    if (hasNegativeNodeHeight) {
      import_ag_charts_core53.Logger.warnOnce(
    ...
    columns.forEach((column, index) => {
      ...
      column.nodes.forEach(({ datum: node }) => {
        ...
        if (text === "")
          return;
        const { height } = CachedTextMeasurerPool10.measureText(text, {
          font: canvasFont,
          textAlign: "left",
          textBaseline: "middle"
        });
  ...
  getNodeStyleOverrides(datumId, datum, datumIndex, size, label, format, highlighted) {
    ...
    if (itemStyler != null) {
      const itemStyle = this.cachedDatumCallback(
        createDatumId22(datumId, "node", highlighted ? "highlight" : "node"),
        () => {
          const {
            fillOpacity = 1,
            strokeOpacity = 1,
  ...
  getLinkStyleOverrides(datumId, datum, datumIndex, format, highlighted) {
    ...
    if (itemStyler != null) {
      const itemStyle = this.cachedDatumCallback(
        createDatumId22(datumId, "link", highlighted ? "highlight" : "node"),
        () => {
          const {
            fillOpacity = 1,
            strokeOpacity = 1,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = import_ag_charts_community161._ModuleSupport;
var sankeySeriesOptionsDef = {
  ...sankeySeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs21,
  type: (0, import_ag_charts_core54.required)((0, import_ag_charts_core54.constant)("sankey")),
  fromKey: (0, import_ag_charts_core54.required)(import_ag_charts_core54.string),
  toKey: (0, import_ag_charts_core54.required)(import_ag_charts_core54.string),
  sizeKey: import_ag_charts_core54.string,
...
sankeySeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core54.undocumented)(import_ag_charts_core54.fillPatternDefaults);
sankeySeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core54.undocumented)(import_ag_charts_core54.fillImageDefaults);
sankeySeriesOptionsDef.defaultColorRange = (0, import_ag_charts_core54.undocumented)((0, import_ag_charts_core54.arrayOf)((0, import_ag_charts_core54.arrayOf)(import_ag_charts_core54.color)));
sankeySeriesOptionsDef.defaultPatternFills = (0, import_ag_charts_core54.undocumented)((0, import_ag_charts_core54.arrayOf)(import_ag_charts_core54.color));
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community162._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community162._ModuleSupport.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: import_ag_charts_community162._ModuleSupport.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
var { HierarchySeriesProperties, HighlightStyle, SeriesTooltip: SeriesTooltip23, Property: Property39 } = import_ag_charts_community163._ModuleSupport;
...
var SunburstNode = class extends import_ag_charts_community164._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends import_ag_charts_community164._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
    ...
    this.sectorGroup = this.scalingGroup.appendChild(new Group17());
    this.sectorLabelGroup = this.scalingGroup.appendChild(new Group17());
    this.highlightSectorGroup = this.scalingGroup.appendChild(new Group17());
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, style, highlighted) => {
      ...
      const fillBBox = import_ag_charts_community164._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community164._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without5 } = import_ag_charts_community165._ModuleSupport;
var sunburstSeriesOptionsDef = {
  ...sunburstSeriesThemeableOptionsDef,
  ...without5(commonSeriesOptionsDefs22, ["highlightStyle"]),
  type: (0, import_ag_charts_core55.required)((0, import_ag_charts_core55.constant)("sunburst")),
  labelKey: import_ag_charts_core55.string,
  secondaryLabelKey: import_ag_charts_core55.string,
  childrenKey: import_ag_charts_core55.string,
  sizeKey: import_ag_charts_core55.string,
  colorKey: import_ag_charts_core55.string,
  sizeName: import_ag_charts_core55.string,
  colorName: import_ag_charts_core55.string
};

// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = import_ag_charts_community166._ModuleSupport;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: import_ag_charts_community166._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community166._ModuleSupport.FILL_IMAGE_DEFAULTS,
      label: {
        fontFamily: { $ref: "fontFamily" },
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, SeriesTooltip: SeriesTooltip24, Property: Property40, Label: Label16 } = import_ag_charts_community167._ModuleSupport;
...
} = import_ag_charts_community168._ModuleSupport;
var TreemapNode = class extends import_ag_charts_community168._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends import_ag_charts_community168._ModuleSupport.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community168._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
    this.NodeClass = TreemapNode;
    this.properties = new TreemapSeriesProperties();
    this.rectGroup = this.contentGroup.appendChild(new Group18());
    this.datumSelection = Selection17.select(this.rectGroup, Rect8);
    this.labelSelection = Selection17.select(this.labelGroup, Group18);
  ...
  applyGap(innerBox, childBox, allLeafNodes) {
    ...
    sides.forEach((side) => {
      if (!(0, import_ag_charts_core56.isNumberEqual)(innerBounds[side], childBounds[side])) {
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community168._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without6 } = import_ag_charts_community169._ModuleSupport;
var treemapSeriesOptionsDef = {
  ...treemapSeriesThemeableOptionsDef,
  ...without6(commonSeriesOptionsDefs23, ["highlightStyle"]),
  type: (0, import_ag_charts_core57.required)((0, import_ag_charts_core57.constant)("treemap")),
  labelKey: import_ag_charts_core57.string,
  secondaryLabelKey: import_ag_charts_core57.string,
  childrenKey: import_ag_charts_core57.string,
  sizeKey: import_ag_charts_core57.string,
  colorKey: import_ag_charts_core57.string,
  sizeName: import_ag_charts_core57.string,
  colorName: import_ag_charts_core57.string
};
treemapSeriesOptionsDef.fillGradientDefaults = (0, import_ag_charts_core57.undocumented)(import_ag_charts_core57.fillGradientDefaults);
treemapSeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core57.undocumented)(import_ag_charts_core57.fillPatternDefaults);
treemapSeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core57.undocumented)(import_ag_charts_core57.fillImageDefaults);
treemapSeriesOptionsDef.undocumentedGroupFills = (0, import_ag_charts_core57.undocumented)((0, import_ag_charts_core57.arrayOf)(import_ag_charts_core57.color));
treemapSeriesOptionsDef.undocumentedGroupStrokes = (0, import_ag_charts_core57.undocumented)((0, import_ag_charts_core57.arrayOf)(import_ag_charts_core57.color));

// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = import_ag_charts_community170._ModuleSupport;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = import_ag_charts_community171._ModuleSupport.ModuleRegistry;
...
var AllFlowProportionEnterpriseModules = [FlowProportionChartModule, ChordSeriesModule, SankeySeriesModule];
var AllGaugeEnterpriseModules = [GaugeChartModule, LinearGaugeSeriesModule, RadialGaugeSeriesModule];
var AllHierarchyEnterpriseModules = [HierarchyChartModule, SunburstSeriesModule, TreemapSeriesModule];
var AllStandaloneEnterpriseModules = [StandaloneChartModule, PyramidSeriesModule];
