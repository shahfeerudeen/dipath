...
var { BaseProperties, ChartAxisDirection, Property: Property2, Group } = _ModuleSupport2;
...
var { OrdinalTimeScale, Property: Property6, TimeAxisParentLevel } = _ModuleSupport8;
...
var { Chart, Property: Property11 } = _ModuleSupport14;
...
// packages/ag-charts-enterprise/src/charts/flowProportionChartModule.ts
var { isAgFlowProportionChartOptions, flowProportionChartOptionsDefs } = _ModuleSupport15;
...
var { Chart: Chart2 } = _ModuleSupport16;
...
// packages/ag-charts-enterprise/src/charts/gaugeChartModule.ts
var { isAgGaugeChartOptions, gaugeChartOptionsDefs } = _ModuleSupport17;
...
var { Chart: Chart3 } = _ModuleSupport18;
...
// packages/ag-charts-enterprise/src/charts/hierarchyChartModule.ts
var { isAgHierarchyChartOptions, hierarchyChartOptionsDefs } = _ModuleSupport19;
...
var { Chart: Chart4 } = _ModuleSupport20;
...
// packages/ag-charts-enterprise/src/charts/standaloneChartModule.ts
var { isAgStandaloneChartOptions, standaloneChartOptionsDefs } = _ModuleSupport21;
...
var { Chart: Chart5, MercatorScale, NumberAxis, Property: Property12 } = _ModuleSupport22;
...
// packages/ag-charts-enterprise/src/charts/topologyChartModule.ts
var { isAgTopologyChartOptions, topologyChartOptionsDefs } = _ModuleSupport23;
...
import {
  _ModuleSupport as _ModuleSupport24
...
var { ScalableGroup, Rect, Line: Line3, BBox: BBox2, Selection: Selection3, applyShapeFillBBox } = _ModuleSupport25;
var BoxPlotGroup = class extends ScalableGroup {
  ...
  distanceSquared(x, y) {
    ...
    return _ModuleSupport25.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
...
var BoxPlotSeriesNodeEvent = class extends _ModuleSupport27.SeriesNodeEvent {
...
var BoxPlotSeries = class extends _ModuleSupport27.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { boxPlotSeriesThemeableOptionsDef, commonSeriesOptionsDefs } = _ModuleSupport28;
...
var { CARTESIAN_AXIS_TYPE } = _ModuleSupport29.ThemeConstants;
  ...
  series: {
    ...
    fill: {
      $if: [
        ...
        { $palette: "fill" },
        { $mix: [_ModuleSupport29.SAFE_FILL_OPERATION, { $ref: "backgroundColor" }, 0.7] }
      ]
    },
    ...
    fillPatternDefaults: _ModuleSupport29.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport29.FILL_IMAGE_DEFAULTS,
    strokeWidth: 2
  },
  axes: {
...
var BoxPlotModule = {
  ...
  defaultAxes: _ModuleSupport30.DIRECTION_SWAP_AXES,
...
import {
  _ModuleSupport as _ModuleSupport32
} from "ag-charts-community";
...
var { findMinMax: findMinMax2 } = _ModuleSupport31;
var X_MIN = 0;
var X_MAX = 1;
var Y_MIN = 2;
var Y_MAX = 3;
...
var OhlcSeriesNodeEvent = class extends _ModuleSupport32.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends _ModuleSupport32.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { Path: Path5, SceneChangeDetection, BBox: BBox3 } = _ModuleSupport33;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { SceneArrayChangeDetection, SceneChangeDetection: SceneChangeDetection2, ExtendedPath2D, BBox: BBox4 } = _ModuleSupport34;
...
var { BaseProperties: BaseProperties3, Property: Property14, AbstractBarSeriesProperties: AbstractBarSeriesProperties2, SeriesTooltip: SeriesTooltip2 } = _ModuleSupport35;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { FillGradientDefaults: FillGradientDefaults2, FillPatternDefaults: FillPatternDefaults2, FillImageDefaults: FillImageDefaults2, BaseProperties: BaseProperties4, SeriesTooltip: SeriesTooltip3, Property: Property15 } = _ModuleSupport36;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { createDatumId: createDatumId3, isGradientFill: isGradientFill2, isPatternFill, isImageFill, getShapeFill, applyShapeStyle, getShapeStyle: getShapeStyle3 } = _ModuleSupport37;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs2, candlestickSeriesThemeableOptionsDef } = _ModuleSupport38;
...
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE2 } = _ModuleSupport39.ThemeConstants;
function itemTheme(key) {
  return {
    ...
    fillPatternDefaults: _ModuleSupport39.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport39.FILL_IMAGE_DEFAULTS
  };
}
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE3, CARTESIAN_POSITION } = _ModuleSupport40.ThemeConstants;
...
var { CachedTextMeasurerPool, TextUtils: TextUtils2, TextWrapper: TextWrapper2 } = _ModuleSupport41;
...
var { Property: Property16 } = _ModuleSupport42;
var BaseAutoSizedLabel = class extends _ModuleSupport42.Label {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, SeriesTooltip: SeriesTooltip4, Property: Property17 } = _ModuleSupport43;
...
var HeatmapSeriesNodeEvent = class extends _ModuleSupport44.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends _ModuleSupport44.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef } = _ModuleSupport45;
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        _ModuleSupport46.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      enabled: false,
...
var { createDatumId: createDatumId5 } = _ModuleSupport48;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, ohlcSeriesThemeableOptionsDef } = _ModuleSupport49;
...
// packages/ag-charts-enterprise/src/series/ohlc/ohlcModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE5, CARTESIAN_POSITION: CARTESIAN_POSITION3 } = _ModuleSupport50.ThemeConstants;
var OhlcModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import {
  _ModuleSupport as _ModuleSupport53
} from "ag-charts-community";
...
var RangeAreaSeriesNodeEvent = class extends _ModuleSupport53.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends _ModuleSupport53.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
      pathsPerSeries: ["fill", "stroke"],
      pickModes: [_ModuleSupport53.SeriesNodePickMode.AXIS_ALIGNED],
      directionKeys: {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs5, rangeAreaSeriesThemeableOptionsDef } = _ModuleSupport54;
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport55.FILL_PATTERN_DEFAULTS,
    stroke: { $palette: "stroke" },
    fillOpacity: 0.7,
    ...
    marker: {
      ...
      fillPatternDefaults: _ModuleSupport55.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport55.FILL_IMAGE_DEFAULTS,
      size: 6,
      strokeWidth: 2
    },
    label: {
  ...
  axes: {
    [_ModuleSupport55.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
var RangeBarSeriesNodeEvent = class extends _ModuleSupport58.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends _ModuleSupport58.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  animateWaitingUpdateReady(data) {
    ...
    const dataDiff = _ModuleSupport58.calculateDataDiff(
      this.id,
      datumSelections,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, rangeBarSeriesThemeableOptionsDef } = _ModuleSupport59;
...
rangeBarSeriesOptionsDef.fastDataProcessing = undocumented4(boolean6);
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport60.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport60.FILL_IMAGE_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
  ...
  axes: {
    [_ModuleSupport60.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: { enabled: true }
    }
  }
};
...
var RangeBarModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: _ModuleSupport61.DIRECTION_SWAP_AXES,
...
var WaterfallSeries = class extends _ModuleSupport63.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [_ModuleSupport63.SMALLEST_KEY_INTERVAL, _ModuleSupport63.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport63.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _ModuleSupport63.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
import { arrayOfDefs as arrayOfDefs2, constant as constant8, positiveNumber as positiveNumber2, required as required8, string as string8, union as union2 } from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, waterfallSeriesThemeableOptionsDef } = _ModuleSupport64;
  ...
  totals: arrayOfDefs2(
    {
      ...
      index: required8(positiveNumber2),
...
function itemTheme2(key, index) {
  return {
    ...
    fillPatternDefaults: _ModuleSupport65.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport65.FILL_IMAGE_DEFAULTS,
...
var WaterfallModule = {
  ...
  tooltipDefaults: { range: "exact" },
  defaultAxes: _ModuleSupport66.DIRECTION_SWAP_AXES,
...
var navigatorHandleOptionsDef = {
  width: positiveNumber3,
  height: positiveNumber3,
  grip: boolean7,
  fill: color2,
  stroke: color2,
  strokeWidth: positiveNumber3,
...
// packages/ag-charts-enterprise/src/features/sync/pluginModules.ts
var { annotationOptionsDef } = _ModuleSupport68;
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection4, Group: Group6, TransformableText } = _ModuleSupport69;
var FlowProportionSeriesNodeEvent = class extends _ModuleSupport69.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var { Path: Path6, SceneChangeDetection: SceneChangeDetection3 } = _ModuleSupport70;
...
import {
  _ModuleSupport as _ModuleSupport71
} from "ag-charts-community";
var {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, chordSeriesThemeableOptionsDef } = _ModuleSupport73;
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport74.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport74.FILL_IMAGE_DEFAULTS,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
var FUNNEL_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport75.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport75.FILL_IMAGE_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
...
var { lineDistanceSquared, BBox: BBox7, Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = _ModuleSupport76;
var delta = 1e-6;
...
var { NODE_UPDATE_STATE_TO_PHASE_MAPPING } = _ModuleSupport77;
...
var FunnelSeriesNodeEvent = class extends _ModuleSupport78.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var BaseFunnelSeries = class extends _ModuleSupport78.AbstractBarSeries {
  constructor({
    moduleCtx,
    animationResetFns
  }) {
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { formatValue, Line: Line4 } = _ModuleSupport80;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef } = _ModuleSupport81;
  ...
  series: {
    ...
    fills: {
      $if: [
        ...
        _ModuleSupport82.SAFE_RANGE2_OPERATION
      ]
    },
    strokes: {
      $if: [
    ...
    fillPatternDefaults: _ModuleSupport82.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport82.FILL_IMAGE_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef } = _ModuleSupport86;
...
import {
  _ModuleSupport as _ModuleSupport93
} from "ag-charts-community";
...
function formatWithContext(ctx, formatter, params) {
  return _ModuleSupport88.callWithContext(ctx.chartService, void 0, formatter, [params]);
}
...
var { BaseProperties: BaseProperties8, Property: Property24 } = _ModuleSupport90;
...
// packages/ag-charts-enterprise/src/series/linear-gauge/linearGaugeSeriesProperties.ts
var { BaseProperties: BaseProperties9, SeriesTooltip: SeriesTooltip11, SeriesProperties: SeriesProperties2, PropertiesArray: PropertiesArray2, Property: Property25, Label: Label7, AxisLabel: AxisLabel3 } = _ModuleSupport91;
...
var LinearGaugeBarProperties = class extends BaseProperties9 {
  constructor() {
    ...
    this.fills = new PropertiesArray2(_ModuleSupport91.StopProperties);
...
import {
  _ModuleSupport as _ModuleSupport92
} from "ag-charts-community";
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, BBox: BBox8 } = _ModuleSupport92;
...
var LinearGaugeSeries = class extends _ModuleSupport93.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      rect.pointerEvents = this.properties.bar.enabled ? _ModuleSupport93.PointerEvents.All : _ModuleSupport93.PointerEvents.None;
      if (animationDisabled || rect.previousDatum == null) {
        rect.setProperties(resetLinearGaugeSeriesResetRectFunction(rect, datum));
      }
    });
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport93.Rect, (node, first, last) => {
      node.pointerEvents = _ModuleSupport93.PointerEvents.None;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          _ModuleSupport94.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["./2", _ModuleSupport94.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          spacing: 11
        }
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: _ModuleSupport94.linearGaugeSeriesOptionsDef,
...
var { LonLatBBox } = _ModuleSupport95;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path8, ExtendedPath2D: ExtendedPath2D2, BBox: BBox10, SceneChangeDetection: SceneChangeDetection5, SceneObjectChangeDetection, objectsEqual } = _ModuleSupport96;
...
var TopologySeriesProperties = class extends _ModuleSupport97.SeriesProperties {
};
var TopologySeries = class extends _ModuleSupport97.DataModelSeries {
...
var { Property: Property26, SeriesProperties: SeriesProperties3, SeriesTooltip: SeriesTooltip12, Label: Label8 } = _ModuleSupport98;
...
var MapLineSeries = class extends TopologySeries {
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = _ModuleSupport99.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without2 } = _ModuleSupport100;
...
mapLineSeriesOptionsDef.colorRange = undocumented6(and(arrayOf3(color3), arrayLength(1)));
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: _ModuleSupport101.SAFE_STROKE_FILL_OPERATION,
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          _ModuleSupport101.SAFE_RANGE2_OPERATION
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
...
var { Property: Property27, SeriesProperties: SeriesProperties4, SeriesTooltip: SeriesTooltip13 } = _ModuleSupport102;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId14, SeriesNodePickMode: SeriesNodePickMode10, Group: Group9, Selection: Selection8, PointerEvents: PointerEvents6 } = _ModuleSupport103;
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = _ModuleSupport104;
...
var { BBox: BBox11 } = _ModuleSupport106;
...
var MapMarkerSeries = class extends TopologySeries {
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = _ModuleSupport108.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without3 } = _ModuleSupport109;
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          _ModuleSupport110.SAFE_RANGE2_OPERATION
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
      ...
      fillPatternDefaults: _ModuleSupport110.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport110.FILL_IMAGE_DEFAULTS,
      fillOpacity: 0.5,
      label: {
        enabled: false,
        fontSize: { $ref: "fontSize" },
...
var { Property: Property29, SeriesProperties: SeriesProperties6, SeriesTooltip: SeriesTooltip15, FillGradientDefaults: FillGradientDefaults10, FillPatternDefaults: FillPatternDefaults10, FillImageDefaults: FillImageDefaults10 } = _ModuleSupport111;
...
var fixedScale = _ModuleSupport112.MercatorScale.fixedScale();
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without4 } = _ModuleSupport113;
    ...
    series: {
      ...
      colorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $palette: "divergingColors" },
          _ModuleSupport114.SAFE_RANGE2_OPERATION
        ]
      },
      // @ts-expect-error undocumented option
      fillGradientDefaults: {
...
var { FillGradientDefaults: FillGradientDefaults11, FillPatternDefaults: FillPatternDefaults11, FillImageDefaults: FillImageDefaults11, Property: Property30, SeriesProperties: SeriesProperties7, SeriesTooltip: SeriesTooltip16 } = _ModuleSupport115;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId17, SeriesNodePickMode: SeriesNodePickMode13, Selection: Selection11, Group: Group12, PointerEvents: PointerEvents8, getShapeStyle: getShapeStyle12 } = _ModuleSupport116;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = _ModuleSupport117;
...
var MapShapeBackgroundModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: {
        ..._ModuleSupport118.FILL_PATTERN_DEFAULTS,
        fill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        stroke: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] }
      },
      fillImageDefaults: _ModuleSupport118.FILL_IMAGE_DEFAULTS
    }
  }
};
...
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport119.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport119.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  legendItemSymbol() {
    ...
    if (_ModuleSupport119.isGradientFill(markerStyle.fill)) {
...
var { motion: motion7 } = _ModuleSupport121;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = _ModuleSupport122;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = _ModuleSupport123;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = _ModuleSupport124;
...
import {
  _ModuleSupport as _ModuleSupport128
} from "ag-charts-community";
...
var PyramidSeries = class extends _ModuleSupport128.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = _ModuleSupport129;
...
var PYRAMID_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport130.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport130.FILL_IMAGE_DEFAULTS,
    label: {
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      fillPatternDefaults: _ModuleSupport132.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport132.FILL_IMAGE_DEFAULTS,
      fillOpacity: 1,
      shape: "circle",
      size: 6,
      strokeOpacity: 1,
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport132.mergeDefaults(
  {
    series: {
      stroke: _ModuleSupport132.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = _ModuleSupport132.mergeDefaults(
  {
    series: {
      fill: { $palette: "fill" },
      fillGradientDefaults: {
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, SeriesTooltip: SeriesTooltip19, Property: Property33 } = _ModuleSupport133;
...
var RadarSeriesNodeEvent = class extends _ModuleSupport134.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport134.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
...
var { FillGradientDefaults: FillGradientDefaults14, FillPatternDefaults: FillPatternDefaults14, FillImageDefaults: FillImageDefaults14, Property: Property34 } = _ModuleSupport135;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group15, Path: Path10, PointerEvents: PointerEvents11, Selection: Selection14, ChartAxisDirection: ChartAxisDirection16, applyShapeStyle: applyShapeStyle13, getShapeFill: getShapeFill4, getShapeStyle: getShapeStyle16 } = _ModuleSupport136;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport136.PolarAxis ? axis : void 0;
    };
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = _ModuleSupport137;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = _ModuleSupport139;
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = _ModuleSupport140.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SectorBox: SectorBox3, motion: motion9 } = _ModuleSupport142;
...
var RadialBarSeriesNodeEvent = class extends _ModuleSupport143.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport143.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  get defaultShapeStyle() {
    ...
    return {
      ...
      rotation: _ModuleSupport143.toDegrees(angleScale.range[0]) + 90
    };
  }
  nodeFactory() {
    return new Sector5();
  ...
  updateSectorSelection(selection, highlighted) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = overrides?.fill ?? style.fill;
      const fillParams = _ModuleSupport143.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = _ModuleSupport144;
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    fillPatternDefaults: _ModuleSupport145.FILL_PATTERN_DEFAULTS,
    fillImageDefaults: _ModuleSupport145.FILL_IMAGE_DEFAULTS,
    strokeWidth: 0,
    label: {
      enabled: false,
      fontSize: { $ref: "fontSize" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = _ModuleSupport146.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property36 } = _ModuleSupport147;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection18, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = _ModuleSupport148;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = _ModuleSupport149;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = _ModuleSupport151.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable } = _ModuleSupport152;
...
import "ag-charts-core";
var { BaseProperties: BaseProperties10, SeriesTooltip: SeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property37, Label: Label14 } = _ModuleSupport153;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(_ModuleSupport153.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = _ModuleSupport154;
...
var RadialGaugeSeries = class extends _ModuleSupport155.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
    ...
    this.tickSelection = Selection15.select(this.tickGroup, _ModuleSupport155.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const fractionDigits = ticks.reduce(
      (f, tick) => Math.max(f, typeof tick === "number" ? countFractionDigits2(tick) : 0),
      0
    );
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? _ModuleSupport155.PointerEvents.All : _ModuleSupport155.PointerEvents.None;
      sector.fill = fill;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport155.Sector, (node, first, last) => {
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = _ModuleSupport156;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          _ModuleSupport156.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["./1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["./2", _ModuleSupport156.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        label: {
          fontWeight: { $ref: "fontWeight" },
          fontSize: { $ref: "fontSize" },
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "gauge",
  enterprise: true,
  options: _ModuleSupport156.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path11, SceneChangeDetection: SceneChangeDetection6, splitBezier } = _ModuleSupport157;
...
import {
  _ModuleSupport as _ModuleSupport158
} from "ag-charts-community";
var {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = _ModuleSupport160;
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      fillPatternDefaults: _ModuleSupport161.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport161.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: _ModuleSupport161.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
...
var { HierarchySeriesProperties, HighlightStyle, SeriesTooltip: SeriesTooltip23, Property: Property39 } = _ModuleSupport162;
...
var SunburstNode = class extends _ModuleSupport163.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends _ModuleSupport163.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, style, highlighted) => {
      ...
      const fillBBox = _ModuleSupport163.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport163.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without5 } = _ModuleSupport164;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = _ModuleSupport165;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport165.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport165.FILL_IMAGE_DEFAULTS,
      label: {
        fontFamily: { $ref: "fontFamily" },
...
import {
  _ModuleSupport as _ModuleSupport167
} from "ag-charts-community";
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, SeriesTooltip: SeriesTooltip24, Property: Property40, Label: Label16 } = _ModuleSupport166;
...
var TreemapNode = class extends _ModuleSupport167.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends _ModuleSupport167.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport167.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport167.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without6 } = _ModuleSupport168;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = _ModuleSupport169;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
      ...
      fillPatternDefaults: _ModuleSupport169.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport169.FILL_IMAGE_DEFAULTS,
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = _ModuleSupport170.ModuleRegistry;
