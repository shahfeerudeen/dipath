...
export declare class BoxPlotGroup extends ScalableGroup implements _ModuleSupport.DistantObject {
    constructor();
    updateDatumStyles(datum: BoxPlotNodeDatum, activeStyles: DeepRequired<AgBoxPlotSeriesStyle>, isVertical: boolean, isReversedValueAxis: boolean | undefined, fillBBox?: _ModuleSupport.ShapeFillBBox): void;
