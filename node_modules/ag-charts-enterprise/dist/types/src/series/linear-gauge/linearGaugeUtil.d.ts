...
export declare function formatLinearGaugeLabels(series: _ModuleSupport.Series<unknown, any, any>, ctx: Ctx, selection: _ModuleSupport.Selection<_ModuleSupport.Text, LinearGaugeLabelDatum>, opts: {
    padding: number;
    horizontal: boolean;
}, bboxes: {
