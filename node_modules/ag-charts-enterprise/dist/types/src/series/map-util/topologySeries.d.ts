...
export declare abstract class TopologySeries<TDatum extends TopologySeriesNodeDatum, TProps extends TopologySeriesProperties<any>, TLabel extends object, TContext extends TopologySeriesNodeDataContext<TDatum, TLabel> = TopologySeriesNodeDataContext<TDatum, TLabel>> extends _ModuleSupport.DataModelSeries<TDatum, TProps, TLabel, TContext> {
