...
export declare class ZoomToolbar extends BaseProperties {
    ...
    constructor(ctx: _ModuleSupport.ModuleContext, getModuleProperties: () => ZoomProperties, getResetZoom: () => DefinedZoomState, updateZoom: (zoom: DefinedZoomState) => void, updateAxisZoom: (axisId: string, direction: _ModuleSupport.CartesianAxisDirection, partialZoom: _ModuleSupport.ZoomState | undefined) => void, resetZoom: () => void, isZoomValid: (zoom: DefinedZoomState) => boolean);
    destroy(): void;
